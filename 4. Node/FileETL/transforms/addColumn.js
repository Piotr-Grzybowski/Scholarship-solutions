...
exports.addColumnFactory = void 0;
const { Transform } = require("stream");
const { EOL } = require("os");
const addColumnFactory = () => {
    ...
    return new Transform({
        ...
        transform(chunk, encoding, callback) {
            ...
            if (!indexesDone) {
                ...
                listedPriceIndex = firstLine.findIndex((element) => element === "Listed Price");
                lastSoldPriceIndex = firstLine.findIndex((element) => element === "Last Sold Price");
...
exports.addColumnFactory = addColumnFactory;
