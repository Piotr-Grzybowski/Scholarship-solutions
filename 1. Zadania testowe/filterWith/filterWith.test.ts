...
describe("Filter with function", () => {
  ...
  it("should return expected value for a name 'Cummings Baxter' 1 2 3", () => {
    ...
    expect(filterWith(data, "Cummings Baxter")).toEqual(
      expect.arrayContaining(expectedValue)
    );
  });
  it("should return expected value for a tag 'nisi", () => {
    const expectedValue = [
      {
        _id: "5e985a07feddae7617ac44f6",
        age: 24,
    ...
    expect(filterWith(data, "nisi")).toEqual(
      expect.arrayContaining(expectedValue)
    );
  });
  it("should return expected value for a name 'Delacruz Acevedo' from friends array", () => {
    const expectedValue = [
      {
        _id: "5e985a074984f9f08ccaaa4c",
        age: 25,
    ...
    expect(filterWith(data, "Delacruz Acevedo")).toEqual(
      expect.arrayContaining(expectedValue)
    );
  });
});
