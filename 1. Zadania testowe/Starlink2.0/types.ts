...
export type changeableProperties =
  | "altitude"
  | "coordinates"
  | "solarSail"
  | "signalBroadcast"
  | "satelliteStatus";
export type changeablePropertiesForOperator =
  | "altitude"
  | "coordinates"
  | "solarSail"
  | "signalBroadcast";
...
export interface ISatellite {
  ...
  changeProperty(
    propertyName: changeableProperties,
    value: changeableValues
  ): void;
}
// union type
// exctract key Record<TChangeProperty, "solarSail">
// type TChangeProperty =
//   | { propertyName: "altitude"; value: number }
//   | { propertyName: "coordinates"; value: coordinates };
